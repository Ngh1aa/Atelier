import { formatVND, isWishlisted, loadProducts, toggleWishlist } from "./commerce-store.js?v=white-editorial-v6";
import { openVariantPicker, showMessage } from "./commerce-ui.js?v=white-editorial-v6";
...
const bookmarkIcon = () => `
  <svg width="12" height="15" viewBox="0 0 10 13" aria-hidden="true">
...
export async function initIndex() {
  ...
  document.querySelectorAll(".product-card").forEach((card) => {
    ...
    const syncWishlist = () => {
      ...
      wishlist.setAttribute("aria-label", `${saved ? "Remove" : "Save"} ${product.name}`);
      wishlist.innerHTML = bookmarkIcon();
    };
